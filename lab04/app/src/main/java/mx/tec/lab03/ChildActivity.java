...
public class ChildActivity extends Activity implements GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener{
            ...
            if (Math.abs(diffX) > Math.abs(diffY)) {
                if (Math.abs(diffX) > SWIPE_THRESHOLD && Math.abs(velocityX) > SWIPE_VELOCITY_THRESHOLD) {
                    if (diffX > 0) {
                        ...
                        Intent i = new Intent(ChildActivity.this,ChildActivity2.class);
                        startActivity(i);
                    }
                    result = true;
                }
